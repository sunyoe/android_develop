...
public class Clock extends View {
    ...
    private float TEXT_RADIUS = 400.0f;// 文字半径
    ...
    private float RADIAN = (float) (Math.PI / 180);// 弧度单位
    ...
    private static final int MSG_REFRESH_SECOND = 1;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        this.hoursValuesColor = DEFAULT_SECONDARY_COLOR;
...
//                invalidate();
    ...
    private void drawHoursValues(Canvas canvas) {
        ...
        mNeedlePaint.setColor(degreesColor);
        mNeedlePaint.setTextAlign(Paint.Align.CENTER);
        mNeedlePaint.setAntiAlias(true);
        for (int i = 1; i <= 12; i++){
            int centerX = (int)(mCenterX + TEXT_RADIUS * Math.sin(30 * i * RADIAN));
            int centerY = (int)(mCenterY + 20f - TEXT_RADIUS * Math.cos(30 * i * RADIAN));
            canvas.drawText(String.format("%d",i), centerX, centerY, mNeedlePaint);
        }
    }
